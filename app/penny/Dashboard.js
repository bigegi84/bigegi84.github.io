    ...
    <div>
      ...
      >
        <div className="sidenav-header">
          ...
          >
            <img
              src="../../template/material-dashboard/assets/img/logo-ct.png"
          ...
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
              <a
                ...
                href="../../template/material-dashboard/pages/tables.html"
              >
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li className="nav-item">
              <a
                className="nav-link text-white "
                href="../../template/material-dashboard/pages/billing.html"
              >
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li className="nav-item">
              <a
                className="nav-link text-white "
                href="../../template/material-dashboard/pages/virtual-reality.html"
              >
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li className="nav-item">
              <a
                className="nav-link text-white "
                href="../../template/material-dashboard/pages/rtl.html"
              >
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li className="nav-item">
              <a
                className="nav-link text-white "
                href="../../template/material-dashboard/pages/notifications.html"
              >
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <ul className="navbar-nav  justify-content-end">
                      ...
                      >
                        <div className="d-flex py-1">
                          <div className="my-auto">
                            <img
                              src="../../template/material-dashboard/assets/img/team-2.jpg"
                    ...
                    <li className="mb-2">
                      ...
                      >
                        <div className="d-flex py-1">
                          <div className="my-auto">
                            <img
                              src="../../template/material-dashboard/assets/img/small-logos/logo-spotify.svg"
                ...
                <li className="nav-item d-flex align-items-center">
                  ...
                  >
                    ...
                    <span className="d-sm-inline d-none">{store.fullName}</span>
                  </a>
                </li>
              </ul>
            </div>
                        ...
                        <tr>
                          <td>
                            <div className="d-flex px-2 py-1">
                              <div>
                                <img
                                  src="../../template/material-dashboard/assets/img/small-logos/logo-xd.svg"
                                  className="avatar avatar-sm me-3"
                                  alt="xd"
                                />
                              </div>
                          ...
                          <td>
                            <div className="avatar-group mt-2">
                              ...
                              >
                                <img
                                  src="../../template/material-dashboard/assets/img/team-1.jpg"
                                  alt="team1"
                                />
                              </a>
                              <a
                              ...
                              >
                                <img
                                  src="../../template/material-dashboard/assets/img/team-3.jpg"
                                  alt="team3"
                                />
                              </a>
                              <a
                              ...
                              >
                                <img
                                  src="../../template/material-dashboard/assets/img/team-4.jpg"
                                  alt="team4"
                                />
                              </a>
                            </div>
                        ...
                        <tr>
                          <td>
                            <div className="d-flex px-2 py-1">
                              <div>
                                <img
                                  src="../../template/material-dashboard/assets/img/small-logos/logo-atlassian.svg"
                                  className="avatar avatar-sm me-3"
                                  alt="atlassian"
                                />
                              </div>
                        ...
                        <tr>
                          <td>
                            <div className="d-flex px-2 py-1">
                              <div>
                                <img
                                  src="../../template/material-dashboard/assets/img/small-logos/logo-slack.svg"
                                  className="avatar avatar-sm me-3"
                                  alt="team7"
                                />
                              </div>
                        ...
                        <tr>
                          <td>
                            <div className="d-flex px-2 py-1">
                              <div>
                                <img
                                  src="../../template/material-dashboard/assets/img/small-logos/logo-jira.svg"
                                  className="avatar avatar-sm me-3"
                                  alt="jira"
                                />
                              </div>
                        ...
                        <tr>
                          <td>
                            <div className="d-flex px-2 py-1">
                              <div>
                                <img
                                  src="../../template/material-dashboard/assets/img/small-logos/logo-invision.svg"
                                  className="avatar avatar-sm me-3"
                                  alt="invision"
                                />
                              </div>
              ...
              <div className="row align-items-center justify-content-lg-between">
                <div className="col-lg-6 mb-lg-0 mb-4">
                  <div className="copyright text-center text-sm text-muted text-lg-start">
                    © Gilang Pratama Wiguna, S.Kom {new Date().getFullYear()}
                  </div>
                </div>
              </div>
            </div>
