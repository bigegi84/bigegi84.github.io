            ...
            e = ()=>(()=>{
                ...
                var s = function() {
                    ...
                    (i = [{
                        ...
                        value: function(t) {
                            for (var e in t)
                                this.validators.has(e) && (t[e] = this.validators.get(e)(t[e]));
                            for (var n in t) {
                                if (!this.optionExists(n))
                                    throw new Error('Unkown option "'.concat(n, '".'));
                                this.checkType(n, t[n])
                            }
                            var o, i = r(this.required.values());
                            try {
                                for (i.s(); !(o = i.n()).done; ) {
                                    var a = o.value;
                                    if (void 0 === t[a])
                                        throw new Error('Option "'.concat(a, '" is required.'))
                                }
                            } catch (t) {
                                i.e(t)
                            } finally {
                        ...
                        value: function(t, e) {
                            if (this.types.has(t)) {
                                var r = this.types.get(t)
                                  , o = n(e);
                                if (o !== r)
                                    throw new Error('Wrong value for option "'.concat(t, '": expected type "').concat(r, '", got "').concat(o, '".'))
                            }
                        }
                    }, {
                        key: "optionExists",
                        ...
                        for (var r = 0; r < e.length; r++) {
                            ...
                            Object.defineProperty(t, (i = function(t, e) {
            ...
            t.exports = (()=>{
                ...
                var n = function() {
                    ...
                    return (e = [{
                        ...
                        value: function(t, e) {
                            Object.prototype.hasOwnProperty.call(this._events, t) || (this._events[t] = []),
                            this._events[t].indexOf(e) < 0 && this._events[t].push(e)
                        }
                    }, {
    ...
    return (()=>{
        ...
        var d, y, v, h = function(t) {
            ...
            r = [{
                key: "resolveOptions",
                value: function(t) {
                    var e, n, r, o, i = t.axis, a = t.button;
                    return {
            ...
            (n = [{
                key: "initAxes",
                value: function() {
                    for (var t = this.axes.length, e = 0; e < t; e++)
                        this.axes[e] = this.resolveAxisValue(e)
                }
            }, {
                key: "initButtons",
                value: function() {
                    for (var t = this.buttons.length, e = 0; e < t; e++)
                        this.buttons[e] = this.resolveButtonValue(e)
                }
            }, {
                key: "update",
                value: function(t) {
                ...
                value: function() {
                    for (var t = this.axes.length, e = 0; e < t; e++)
                        this.setAxisValue(e, this.resolveAxisValue(e))
                }
            }, {
                key: "updateButtons",
                value: function() {
                    for (var t = this.buttons.length, e = 0; e < t; e++)
                        this.setButtonValue(e, this.resolveButtonValue(e))
                }
            }, {
                key: "setAxisValue",
                value: function(t, e) {
                    this.axes[t] !== e && (this.axes[t] = e,
                    this.emit("axis", {
                ...
                key: "setButtonValue",
                value: function(t, e) {
                    this.buttons[t] !== e && (this.buttons[t] = e,
                    this.emit("button", {
                        gamepad: this.gamepad,
                        index: this.index,
                        button: t,
                        pressed: this.gamepad.buttons[t].pressed,
                        value: e
                    }))
                }
            }, {
        ...
        (y = p(y))in d ? Object.defineProperty(d, y, {
            value: v,
            enumerable: !0,
            configurable: !0,
            writable: !0
        ...
        var A = function(t) {
            ...
            (n = [{
                ...
                key: "discover",
                value: function(t, e) {
                    t ? (null === this.handlers[e] && this.registerHandler(e, t),
                    this.handlers[e].update(t)) : this.handlers[e] && this.removeGamepad(e)
                }
            }, {
                key: "registerHandler",
                value: function(t, e) {
                    ...
                    this.emit("gamepad:".concat(t, ":connected"), {
                        index: t,
                        gamepad: e
                    })
                }
                ...
                value: function(t) {
                    ...
                    e.removeEventListener("axis", this.onAxis),
                    e.removeEventListener("button", this.onButton),
                    this.handlers[t] = null,
                    this.emit("gamepad:disconnected", {
                        index: t
                    }),
                    this.emit("gamepad:".concat(t, ":disconnected"), {
                        index: t
                    })
                }
            }, {
                ...
                value: function(t) {
                    ...
                    this.emit("gamepad:axis", t.detail),
                    this.emit("gamepad:".concat(e, ":axis"), t.detail),
                    this.emit("gamepad:".concat(e, ":axis:").concat(t.detail.axis), t.detail)
                }
            }, {
                key: "onButton",
                value: function(t) {
                    var e = t.detail.index;
                    this.emit("gamepad:button", t.detail),
                    this.emit("gamepad:".concat(e, ":button"), t.detail),
                    this.emit("gamepad:".concat(e, ":button:").concat(t.detail.button), t.detail)
                }
            }]) && j(e.prototype, n),
            Object.defineProperty(e, "prototype", {
                writable: !1
