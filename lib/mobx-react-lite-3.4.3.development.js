...
var observerFinalizationRegistry =
  /*#__PURE__*/ new UniversalFinalizationRegistry(function (adm) {
    var _adm$reaction;
...
function useObserver(fn, baseComponentName) {
  ...
  if (!adm.reaction) {
    ...
    adm.reaction = new mobx.Reaction(
...
var ReactForwardRefSymbol = hasSymbol
  ...
  : typeof React.forwardRef === "function" &&
    /*#__PURE__*/ React.forwardRef(function (props) {
      return null;
    })["$$typeof"];
...
function observer(
  ...
  var useForwardRef =
    (_options$forwardRef = options == null ? void 0 : options.forwardRef) !=
    null
      ? _options$forwardRef
      : false;
...
var clearTimers =
  (_observerFinalization =
    observerFinalizationRegistry["finalizeAllImmediately"]) != null
    ? _observerFinalization
    : function () {};
