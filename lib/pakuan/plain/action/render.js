define((require) => {
  ...
  var {
    ...
    text: { textHighlight, textRegular, textResult, textStamp, textStrong },
  } = require('../view/index')
  var main = (obj) => {
    var component = []
    // console.log(obj);
    for (var key in obj) {
      ...
      if (!found && key.includes('textResult')) {
        found = true
        component.push(
          textResult(key.replace('textResult', ''), obj[key])
        )
      }
